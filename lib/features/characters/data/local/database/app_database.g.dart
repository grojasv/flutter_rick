    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `CharacterEntity` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `gender` TEXT NOT NULL, `origin` TEXT NOT NULL, `image` TEXT NOT NULL, `status` TEXT NOT NULL, `species` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$CharacterDao extends CharacterDao {
  ...
  @override
  Future<void> insertCharacter(CharacterEntity characterEntity) async {
    await _characterEntityInsertionAdapter.insert(
        characterEntity, OnConflictStrategy.ignore);
  }
}
